    ...
    return(
        <div>
            ...
            <div className="LoginDiv">
                ...
                <input type="text" className="password" value={password} onChange={(e)=> {setPassword(e.target.value)}} required/>            
            </div>
            <div className="loginSubmit">
                <input type="submit" aria-label="loginButton" onClick={() => {handleClick()}} className="loginButton"/>
            </div>     
            { signup 
                ? <div><p>Sign Up</p><button className='signupButton' onClick={() => {toggleSignUp(false)}}>Return to Login</button></div> 
                : <div className="signupToggle"> <p>Sign Up Instead</p><button className = 'signupButton' onClick={() => {toggleSignUp(true)}}>Sign Up</button></div>
            }
